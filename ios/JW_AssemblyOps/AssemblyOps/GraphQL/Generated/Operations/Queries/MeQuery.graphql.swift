...
extension AssemblyOpsAPI {
  class MeQuery: GraphQLQuery {
    ...
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query Me { me { __typename id email firstName lastName fullName phone congregationId congregationRef { __typename id name city state circuit { __typename id code } } } }"#
      ))
