...
extension AssemblyOpsAPI {
  class MyLanyardStatusQuery: GraphQLQuery {
    static let operationName: String = "MyLanyardStatus"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyLanyardStatus($eventId: ID!, $date: String) { myLanyardStatus(eventId: $eventId, date: $date) { __typename id eventVolunteerId eventId date pickedUpAt returnedAt volunteerName } }"#
      ))
    ...
    struct Data: AssemblyOpsAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("myLanyardStatus", MyLanyardStatus?.self, arguments: [
          "eventId": .variable("eventId"),
          "date": .variable("date")
        ]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        MyLanyardStatusQuery.Data.self
      ] }

      var myLanyardStatus: MyLanyardStatus? { __data["myLanyardStatus"] }

      /// MyLanyardStatus
      ///
      /// Parent Type: `LanyardCheckout`
      struct MyLanyardStatus: AssemblyOpsAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          MyLanyardStatusQuery.Data.MyLanyardStatus.self
        ] }
