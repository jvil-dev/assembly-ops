...
extension AssemblyOpsAPI {
  class AttendantMeetingsQuery: GraphQLQuery {
    ...
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query AttendantMeetings($eventId: ID!) { attendantMeetings(eventId: $eventId) { __typename id session { __typename id name date } meetingDate notes createdBy { __typename id firstName lastName } attendees { __typename id eventVolunteer { __typename id volunteerProfile { __typename firstName lastName } } } createdAt } }"#
      ))
      ...
      struct AttendantMeeting: AssemblyOpsAPI.SelectionSet {
        ...
        struct Attendee: AssemblyOpsAPI.SelectionSet {
          ...
          struct EventVolunteer: AssemblyOpsAPI.SelectionSet {
            ...
            /// AttendantMeeting.Attendee.EventVolunteer.VolunteerProfile
            ///
            ...
            struct VolunteerProfile: AssemblyOpsAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                AttendantMeetingsQuery.Data.AttendantMeeting.Attendee.EventVolunteer.VolunteerProfile.self
              ] }
