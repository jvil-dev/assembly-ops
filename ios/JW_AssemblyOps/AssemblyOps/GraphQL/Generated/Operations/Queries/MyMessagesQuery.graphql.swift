...
extension AssemblyOpsAPI {
  class MyMessagesQuery: GraphQLQuery {
    ...
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyMessages($filter: MessageFilterInput, $limit: Int, $offset: Int) { myMessages(filter: $filter, limit: $limit, offset: $offset) { __typename id subject body recipientType senderType senderName senderId isRead readAt createdAt conversation { __typename id } } }"#
      ))
