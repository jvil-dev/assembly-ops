...
extension AssemblyOpsAPI {
  class CaptainShiftsQuery: GraphQLQuery {
    static let operationName: String = "CaptainShifts"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query CaptainShifts($sessionId: ID!, $postId: ID) { captainShifts(sessionId: $sessionId, postId: $postId) { __typename id name startTime endTime session { __typename id name } post { __typename id name } createdAt createdBy { __typename id firstName lastName } assignments { __typename id eventVolunteer { __typename id user { __typename id firstName lastName } } status checkIn { __typename id } } } }"#
      ))
    ...
    struct Data: AssemblyOpsAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("captainShifts", [CaptainShift].self, arguments: [
          "sessionId": .variable("sessionId"),
          "postId": .variable("postId")
        ]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        CaptainShiftsQuery.Data.self
      ] }

      var captainShifts: [CaptainShift] { __data["captainShifts"] }

      /// CaptainShift
      ///
      /// Parent Type: `Shift`
      struct CaptainShift: AssemblyOpsAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          CaptainShiftsQuery.Data.CaptainShift.self
        ] }
        ...
        struct Session: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            CaptainShiftsQuery.Data.CaptainShift.Session.self
          ] }
        ...
        struct Post: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            CaptainShiftsQuery.Data.CaptainShift.Post.self
          ] }
        ...
        struct CreatedBy: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            CaptainShiftsQuery.Data.CaptainShift.CreatedBy.self
          ] }
        ...
        struct Assignment: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            CaptainShiftsQuery.Data.CaptainShift.Assignment.self
          ] }
          ...
          /// CaptainShift.Assignment.EventVolunteer
          ///
          ...
          struct EventVolunteer: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              CaptainShiftsQuery.Data.CaptainShift.Assignment.EventVolunteer.self
            ] }

            var id: AssemblyOpsAPI.ID { __data["id"] }
            var user: User { __data["user"] }

            /// CaptainShift.Assignment.EventVolunteer.User
            ///
            /// Parent Type: `User`
            struct User: AssemblyOpsAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                CaptainShiftsQuery.Data.CaptainShift.Assignment.EventVolunteer.User.self
              ] }
          ...
          /// CaptainShift.Assignment.CheckIn
          ///
          /// Parent Type: `CheckIn`
          struct CheckIn: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              CaptainShiftsQuery.Data.CaptainShift.Assignment.CheckIn.self
            ] }
