...
extension AssemblyOpsAPI {
  class CreateAttendantMeetingMutation: GraphQLMutation {
    ...
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation CreateAttendantMeeting($input: CreateAttendantMeetingInput!) { createAttendantMeeting(input: $input) { __typename id session { __typename id name } meetingDate notes attendees { __typename id eventVolunteer { __typename id volunteerProfile { __typename firstName lastName } } } createdAt } }"#
      ))
      ...
      struct CreateAttendantMeeting: AssemblyOpsAPI.SelectionSet {
        ...
        struct Attendee: AssemblyOpsAPI.SelectionSet {
          ...
          struct EventVolunteer: AssemblyOpsAPI.SelectionSet {
            ...
            /// CreateAttendantMeeting.Attendee.EventVolunteer.VolunteerProfile
            ///
            ...
            struct VolunteerProfile: AssemblyOpsAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                CreateAttendantMeetingMutation.Data.CreateAttendantMeeting.Attendee.EventVolunteer.VolunteerProfile.self
              ] }
