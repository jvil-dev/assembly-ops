...
extension AssemblyOpsAPI {
  class ForceAssignmentMutation: GraphQLMutation {
    ...
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation ForceAssignment($input: ForceAssignmentInput!) { forceAssignment(input: $input) { __typename assignment { __typename id status forceAssigned volunteer { __typename id firstName lastName } post { __typename id name } session { __typename id name } } warning } }"#
      ))
    ...
    struct Data: AssemblyOpsAPI.SelectionSet {
      ...
      /// ForceAssignment
      ///
      /// Parent Type: `ForceAssignmentResult`
      struct ForceAssignment: AssemblyOpsAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }

        static var __parentType: any ApolloAPI.ParentType { AssemblyOpsAPI.Objects.ForceAssignmentResult }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        struct Assignment: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            ForceAssignmentMutation.Data.ForceAssignment.Assignment.self
          ] }
          ...
          /// ForceAssignment.Assignment.Volunteer
          ///
          ...
          struct Volunteer: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              ForceAssignmentMutation.Data.ForceAssignment.Assignment.Volunteer.self
            ] }
          ...
          /// ForceAssignment.Assignment.Post
          ///
          /// Parent Type: `Post`
          struct Post: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              ForceAssignmentMutation.Data.ForceAssignment.Assignment.Post.self
            ] }
          ...
          /// ForceAssignment.Assignment.Session
          ///
          /// Parent Type: `Session`
          struct Session: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              ForceAssignmentMutation.Data.ForceAssignment.Assignment.Session.self
            ] }
