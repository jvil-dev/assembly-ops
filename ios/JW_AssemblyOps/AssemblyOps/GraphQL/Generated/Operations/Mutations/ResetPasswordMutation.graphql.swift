  ...
  class ResetPasswordMutation: GraphQLMutation {
    ...
    struct Data: AssemblyOpsAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("resetPassword", ResetPassword.self, arguments: ["input": .variable("input")]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        ResetPasswordMutation.Data.self
      ] }

      var resetPassword: ResetPassword { __data["resetPassword"] }

      /// ResetPassword
      ///
      /// Parent Type: `UserAuthPayload`
      struct ResetPassword: AssemblyOpsAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          ResetPasswordMutation.Data.ResetPassword.self
        ] }
        ...
        struct User: AssemblyOpsAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            ResetPasswordMutation.Data.ResetPassword.User.self
          ] }
          ...
          /// ResetPassword.User.CongregationRef
          ///
          ...
          struct CongregationRef: AssemblyOpsAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              ResetPasswordMutation.Data.ResetPassword.User.CongregationRef.self
            ] }
            ...
            /// ResetPassword.User.CongregationRef.Circuit
            ///
            /// Parent Type: `Circuit`
            struct Circuit: AssemblyOpsAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                ResetPasswordMutation.Data.ResetPassword.User.CongregationRef.Circuit.self
              ] }
