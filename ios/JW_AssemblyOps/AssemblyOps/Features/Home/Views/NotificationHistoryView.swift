...
struct NotificationHistoryView: View {
    ...
    private func notificationRow(_ notification: NotificationItem) -> some View {
        Group {
            if notification.isMessageType,
               let parsed = NotificationData(jsonString: notification.data),
               let conversationId = parsed.conversationId {
                NavigationLink {
                    ConversationDetailView(
                        conversationId: conversationId,
                        otherParticipantName: notification.title,
    ...
    private func notificationRowContent(_ notification: NotificationItem) -> some View {
