//
//  AudioEquipmentViewModel.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Audio Equipment ViewModel
//
// Manages equipment list CRUD, checkout/return, and filtering.
// Supports category filtering and search.
//
// Used by: AudioEquipmentListView, AudioEquipmentDetailView,
//          CreateEquipmentSheet, BulkCreateEquipmentSheet, CheckoutEquipmentSheet

import Foundation
import Combine

@MainActor
final class AudioEquipmentViewModel: ObservableObject {
    ...
    func loadEquipment(eventId: String) async {
        ...
        do {
            ...
            // Pre-filter to audio-relevant categories
            equipment = all.filter { AudioEquipmentCategoryItem.audioRelevantCategories.contains($0.category) }
        } catch {
