//
//  AudioDamageViewModel.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Audio Damage ViewModel
//
// Manages damage report list, creation, and resolution.
// Supports resolved/unresolved filtering.
//
// Used by: AudioDamageReportsView, ResolveDamageSheet, ReportDamageView

import Foundation
import Combine

@MainActor
final class AudioDamageViewModel: ObservableObject {
