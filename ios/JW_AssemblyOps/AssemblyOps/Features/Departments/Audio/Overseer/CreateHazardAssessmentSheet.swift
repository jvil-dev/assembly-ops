//
//  CreateHazardAssessmentSheet.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Create Hazard Assessment Sheet
//
// Form for creating a Job Hazard Analysis (JHA).
// Fields: title, hazard type, description, controls, PPE multi-select.

import SwiftUI

struct CreateHazardAssessmentSheet: View {
...
#Preview {
    CreateHazardAssessmentSheet(viewModel: AudioSafetyViewModel())
}
