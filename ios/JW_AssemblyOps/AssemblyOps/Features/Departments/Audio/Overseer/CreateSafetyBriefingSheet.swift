//
//  CreateSafetyBriefingSheet.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Create Safety Briefing Sheet
//
// Form for creating a new safety briefing.
// Fields: topic, notes, attendee IDs (multi-line input for now).

import SwiftUI

struct CreateSafetyBriefingSheet: View {
    @ObservedObject var viewModel: AudioSafetyViewModel
...
#Preview {
    CreateSafetyBriefingSheet(viewModel: AudioSafetyViewModel())
}
