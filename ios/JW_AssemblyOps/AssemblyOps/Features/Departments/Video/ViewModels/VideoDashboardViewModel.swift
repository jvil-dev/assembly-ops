//
//  VideoDashboardViewModel.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Video Dashboard ViewModel
//
// Loads aggregate data for the Video overseer dashboard.
// Fetches equipment summary (video categories only), unresolved damage,
// hazard assessments, and safety briefings in parallel.
//
// Used by: VideoDashboardView

import Foundation
import Combine

@MainActor
final class VideoDashboardViewModel: ObservableObject {
