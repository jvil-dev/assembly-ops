//
//  VideoSafetyViewModel.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Video Safety ViewModel
//
// Manages hazard assessments and safety briefings for the Video crew.
// Delegates to AudioVideoService (shared backend).
//
// Used by: VideoHazardAssessmentView, CreateVideoHazardAssessmentSheet,
//          VideoSafetyBriefingsView, CreateVideoSafetyBriefingSheet

import Foundation
import Combine

@MainActor
final class VideoSafetyViewModel: ObservableObject {
