//
//  CreateVideoEquipmentSheet.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Create Video Equipment Sheet
//
// Form for adding a single video equipment item.
// Category picker is scoped to video-relevant categories only.

import SwiftUI

struct CreateVideoEquipmentSheet: View {
...
#Preview {
    CreateVideoEquipmentSheet(viewModel: VideoEquipmentViewModel())
}
