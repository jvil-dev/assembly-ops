//
//  ReportVideoDamageView.swift
//  AssemblyOps
//
//  Created by Jorge Villeda on 2/27/26.
//

// MARK: - Report Video Damage View
//
// Volunteer-facing form for reporting video equipment damage.
// Can be initialized with a specific equipment ID or with a list to pick from.

import SwiftUI

struct ReportVideoDamageView: View {
